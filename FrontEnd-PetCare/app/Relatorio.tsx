...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    padding: 20,
    backgroundColor: '#32312F', // Cor marrom claro (igual ao estilo de GerenciamentoUser)
  },
  title: {
    fontSize: 24,
    fontWeight: 'bold',
    color: '#fff', // Cor do texto mais escura para o título
    marginBottom: 20,
    textAlign: 'center',
  },
  header: {
  ...
  menuButton: {
    backgroundColor: '#00635D', // Cor marrom escuro (igual ao estilo de GerenciamentoUser)
    marginBottom: 10,
  },
  searchButton: {
    backgroundColor: '#00635D', // Cor marrom escuro para o botão de pesquisa
    marginVertical: 10,
  },
  agendamentoItem: {
    padding: 10,
